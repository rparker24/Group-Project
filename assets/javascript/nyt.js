$('#submit').on('click', function() {    
    ...
    var queryURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=glocations%3A%28%22" + city + "%22%29&begin_date=19250101&sort=oldest&fl=headline%2Csnippet%2Cpub_date%2Ckeywords&api-key=9d4a8986921972b65754ea0809d47c84%3A12%3A74623931";
        $.ajax({
                url: queryURL,
                method: 'GET'
            })
