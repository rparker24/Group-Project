...
$('#submit').on('click', function() {    
	var city = $('#address').val();
	var queryURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=glocations%3A%28%22" + city + "%22%29&begin_date=19000101&sort=oldest&fl=headline%2Csnippet%2Cpub_date%2Ckeywords&api-key=9d4a8986921972b65754ea0809d47c84%3A12%3A74623931";
        $.ajax({
                url: queryURL,
                method: 'GET'
            })
...
>>>>>>> 6bd0efa73ce35a88aeb69ed14c1e42e0dcdd9fdf
});